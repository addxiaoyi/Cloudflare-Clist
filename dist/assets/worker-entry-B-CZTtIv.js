  ...
  if (done) {
    ...
    return /* @__PURE__ */ reactExports.createElement(
      ...
      /* @__PURE__ */ reactExports.createElement(
        ...
        null,
        /* @__PURE__ */ reactExports.createElement(StreamTransfer, {
          context,
...
function getRouteComponents(route, routeModule, isSpaMode) {
  ...
  if (route.id === 'root' && routeModule.Layout) {
    return {
      ...(Component4
        ? {
            element: /* @__PURE__ */ reactExports.createElement(
              routeModule.Layout,
              null,
              /* @__PURE__ */ reactExports.createElement(Component4, null),
            ),
          }
        : { Component: Component4 }),
      ...(ErrorBoundary
        ? {
            errorElement: /* @__PURE__ */ reactExports.createElement(
              routeModule.Layout,
              null,
              /* @__PURE__ */ reactExports.createElement(ErrorBoundary, null),
            ),
          }
        : { ErrorBoundary }),
      ...(HydrateFallback
        ? {
            hydrateFallbackElement: /* @__PURE__ */ reactExports.createElement(
              routeModule.Layout,
              null,
              /* @__PURE__ */ reactExports.createElement(HydrateFallback, null),
            ),
          }
        : { HydrateFallback }),
    };
  ...
  return /* @__PURE__ */ reactExports.createElement(
    ...
    meta.flat().map((metaProps) => {
      ...
      if ('tagName' in metaProps) {
        ...
        let Comp = tagName;
        return /* @__PURE__ */ reactExports.createElement(Comp, {
...
function BoundaryShell({ title, renderScripts, isOutsideRemixApp, children }) {
  ...
  return /* @__PURE__ */ reactExports.createElement(
    ...
    /* @__PURE__ */ reactExports.createElement(
      'head',
      null,
      /* @__PURE__ */ reactExports.createElement('meta', { charSet: 'utf-8' }),
      /* @__PURE__ */ reactExports.createElement('meta', {
        name: 'viewport',
    ...
    /* @__PURE__ */ reactExports.createElement(
      ...
      /* @__PURE__ */ reactExports.createElement(
        ...
        children,
        renderScripts
          ? /* @__PURE__ */ reactExports.createElement(Scripts, null)
          : null,
      ),
    ),
  );
...
try {
  if (isBrowser) {
    window.__reactRouterVersion = '7.10.1'; // @ts-expect-error
  }
} catch (e) {}
        ...
        /* @__PURE__ */ reactExports.createElement(
          ...
          /* @__PURE__ */ reactExports.createElement(
            ...
            /* @__PURE__ */ reactExports.createElement(
              ...
              /* @__PURE__ */ reactExports.createElement(DataRoutes2, {
...
function ErrorWrapper({ renderAppShell, title, children }) {
  ...
  return /* @__PURE__ */ React3.createElement(
    ...
    /* @__PURE__ */ React3.createElement(
      'head',
      null,
      /* @__PURE__ */ React3.createElement('meta', { charSet: 'utf-8' }),
      /* @__PURE__ */ React3.createElement('meta', {
        name: 'viewport',
        content: 'width=device-width,initial-scale=1,viewport-fit=cover',
      }),
      /* @__PURE__ */ React3.createElement('title', null, title),
    ),
    /* @__PURE__ */ React3.createElement(
      'body',
      null,
...
const requestHandler = createRequestHandler(
  () => import('./server-build-CF5kOQEW.js'),
  'production',
);
const app = {
